...
class TestChat:
    ...
    def test_method_stream(self, client: Honcho) -> None:
        chat = client.apps.users.sessions.chat.stream(
    ...
    def test_raw_response_stream(self, client: Honcho) -> None:
        response = client.apps.users.sessions.chat.with_raw_response.stream(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            app_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            query="string",
    ...
    def test_streaming_response_stream(self, client: Honcho) -> None:
        with client.apps.users.sessions.chat.with_streaming_response.stream(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            app_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            query="string",
    ...
    def test_path_params_stream(self, client: Honcho) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `app_id` but received ''"):
            client.apps.users.sessions.chat.with_raw_response.stream(
                "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                app_id="",
                user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                query="string",
...
class TestAsyncChat:
    ...
    async def test_method_stream(self, async_client: AsyncHoncho) -> None:
        chat = await async_client.apps.users.sessions.chat.stream(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            app_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            query="string",
    ...
    async def test_raw_response_stream(self, async_client: AsyncHoncho) -> None:
        response = await async_client.apps.users.sessions.chat.with_raw_response.stream(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            app_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            query="string",
    ...
    async def test_streaming_response_stream(self, async_client: AsyncHoncho) -> None:
        async with async_client.apps.users.sessions.chat.with_streaming_response.stream(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            app_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            query="string",
    ...
    async def test_path_params_stream(self, async_client: AsyncHoncho) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `app_id` but received ''"):
            await async_client.apps.users.sessions.chat.with_raw_response.stream(
                "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                app_id="",
                user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                query="string",

...
class TestName:
    ...
    def test_method_retrieve(self, client: Honcho) -> None:
        name = client.apps.users.name.retrieve(
            "string",
            app_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(User, name, path=["response"])

    @parametrize
    def test_raw_response_retrieve(self, client: Honcho) -> None:
        response = client.apps.users.name.with_raw_response.retrieve(
            "string",
            app_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_retrieve(self, client: Honcho) -> None:
        with client.apps.users.name.with_streaming_response.retrieve(
            "string",
            app_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Honcho) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `app_id` but received ''"):
            client.apps.users.name.with_raw_response.retrieve(
                "string",
                app_id="",
            )
...
class TestAsyncName:
    ...
    async def test_method_retrieve(self, async_client: AsyncHoncho) -> None:
        name = await async_client.apps.users.name.retrieve(
            "string",
            app_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(User, name, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncHoncho) -> None:
        response = await async_client.apps.users.name.with_raw_response.retrieve(
            "string",
            app_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncHoncho) -> None:
        async with async_client.apps.users.name.with_streaming_response.retrieve(
            "string",
            app_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncHoncho) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `app_id` but received ''"):
            await async_client.apps.users.name.with_raw_response.retrieve(
                "string",
                app_id="",
            )
